...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			//en_us: '<img src="http://foothillsresearchinstitute.ca/images/ecotour_icon_test.png" style="width:70px;height:70px;float:left;margin:15px 15px 15px 15px"></img>Install this web app on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
